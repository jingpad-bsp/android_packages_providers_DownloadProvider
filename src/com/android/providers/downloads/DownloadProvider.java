...
public final class DownloadProvider extends ContentProvider {
    ...
    private final class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private void upgradeTo(SQLiteDatabase db, int version) {
            switch (version) {
                ...
                case 113:
                    ...
                    if(!checkColumnExists(db,DB_TABLE,Constants.RIGHTS_ISSUER)) {
        ...
        /**
         * Check datatable column existing before add column to datatable.
         */
        private boolean checkColumnExists(SQLiteDatabase db, String tableName, String columnName) {
            ...
            try {
                ...
                Log.e(Constants.TAG, "checkColumnExists: " + e.getMessage());
            } finally {
